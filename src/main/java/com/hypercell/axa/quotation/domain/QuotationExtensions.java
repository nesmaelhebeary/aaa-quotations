...
public class QuotationExtensions implements Serializable {
    ...
    @Column(name = "entension_percentage_type")
    private EntensionPercentageType entensionPercentageType;
    ...
    public EntensionPercentageType getEntensionPercentageType() {
        return this.entensionPercentageType;
    }

    public QuotationExtensions entensionPercentageType(EntensionPercentageType entensionPercentageType) {
        this.entensionPercentageType = entensionPercentageType;
        return this;
    }

    public void setEntensionPercentageType(EntensionPercentageType entensionPercentageType) {
        this.entensionPercentageType = entensionPercentageType;
    }
    ...
    public String toString() {
        return "QuotationExtensions{" +
            ...
            ", entensionPercentageType='" + getEntensionPercentageType() + "'" +
