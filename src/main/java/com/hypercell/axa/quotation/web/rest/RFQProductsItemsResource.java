...
public class RFQProductsItemsResource {
    ...
    private static final String ENTITY_NAME = "aaaRfqProductsItems";
        ...
        Optional<RFQProductsItems> result = rFQProductsItemsRepository
            ...
            .map(
                existingRFQProductsItems -> {
                    ...
                    if (rFQProductsItems.getItemDesc() != null) {
                        existingRFQProductsItems.setItemDesc(rFQProductsItems.getItemDesc());
                    }
