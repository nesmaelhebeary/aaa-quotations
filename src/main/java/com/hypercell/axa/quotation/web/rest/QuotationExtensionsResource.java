...
public class QuotationExtensionsResource {
    ...
    private static final String ENTITY_NAME = "aaaQuotationExtensions";
        ...
        Optional<QuotationExtensions> result = quotationExtensionsRepository
            ...
            .map(
                existingQuotationExtensions -> {
                    ...
                    if (quotationExtensions.getEntensionPercentageType() != null) {
                        existingQuotationExtensions.setEntensionPercentageType(quotationExtensions.getEntensionPercentageType());
                    }
