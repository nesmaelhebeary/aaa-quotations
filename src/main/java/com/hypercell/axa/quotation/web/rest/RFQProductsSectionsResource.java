...
public class RFQProductsSectionsResource {
    ...
    private static final String ENTITY_NAME = "aaaRfqProductsSections";
        ...
        Optional<RFQProductsSections> result = rFQProductsSectionsRepository
            ...
            .map(
                existingRFQProductsSections -> {
                    ...
                    if (rFQProductsSections.getCurrency() != null) {
                        existingRFQProductsSections.setCurrency(rFQProductsSections.getCurrency());
                    }
                    if (rFQProductsSections.getRfqId() != null) {
                        existingRFQProductsSections.setRfqId(rFQProductsSections.getRfqId());
                    }
