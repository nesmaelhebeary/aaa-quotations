...
public class RFQProductsInfoValueListResource {
    ...
    private static final String ENTITY_NAME = "aaaRfqProductsInfoValueList";
        ...
        Optional<RFQProductsInfoValueList> result = rFQProductsInfoValueListRepository
            ...
            .map(
                existingRFQProductsInfoValueList -> {
                    if (rFQProductsInfoValueList.getProductValueAttrId() != null) {
                        existingRFQProductsInfoValueList.setProductValueAttrId(rFQProductsInfoValueList.getProductValueAttrId());
                    }
