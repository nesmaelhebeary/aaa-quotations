...
class RFQProductsInfoValueListResourceIT {
    ...
    public static RFQProductsInfoValueList createEntity(EntityManager em) {
        RFQProductsInfoValueList rFQProductsInfoValueList = new RFQProductsInfoValueList()
    ...
    void createRFQProductsInfoValueList() throws Exception {
        ...
        assertThat(testRFQProductsInfoValueList.getProductValueAttrId()).isEqualTo(DEFAULT_PRODUCT_VALUE_ATTR_ID);
    ...
    void putNewRFQProductsInfoValueList() throws Exception {
        ...
        updatedRFQProductsInfoValueList.productValueAttrId(UPDATED_PRODUCT_VALUE_ATTR_ID).attributeValue(UPDATED_ATTRIBUTE_VALUE);
        ...
        RFQProductsInfoValueList testRFQProductsInfoValueList = rFQProductsInfoValueListList.get(rFQProductsInfoValueListList.size() - 1);
        assertThat(testRFQProductsInfoValueList.getProductValueAttrId()).isEqualTo(UPDATED_PRODUCT_VALUE_ATTR_ID);
    ...
    void partialUpdateRFQProductsInfoValueListWithPatch() throws Exception {
        ...
        partialUpdatedRFQProductsInfoValueList.productValueAttrId(UPDATED_PRODUCT_VALUE_ATTR_ID);
    ...
    void fullUpdateRFQProductsInfoValueListWithPatch() throws Exception {
        ...
        partialUpdatedRFQProductsInfoValueList.productValueAttrId(UPDATED_PRODUCT_VALUE_ATTR_ID).attributeValue(UPDATED_ATTRIBUTE_VALUE);
