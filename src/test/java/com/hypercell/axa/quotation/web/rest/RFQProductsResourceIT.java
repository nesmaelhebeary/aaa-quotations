...
class RFQProductsResourceIT {
    ...
    public static RFQProducts createEntity(EntityManager em) {
        RFQProducts rFQProducts = new RFQProducts().rfqId(DEFAULT_RFQ_ID).productId(DEFAULT_PRODUCT_ID).coverType(DEFAULT_COVER_TYPE);
        return rFQProducts;
    }
    ...
    public static RFQProducts createUpdatedEntity(EntityManager em) {
        RFQProducts rFQProducts = new RFQProducts().rfqId(UPDATED_RFQ_ID).productId(UPDATED_PRODUCT_ID).coverType(UPDATED_COVER_TYPE);
        return rFQProducts;
    }
    ...
    void putNewRFQProducts() throws Exception {
        ...
        updatedRFQProducts.rfqId(UPDATED_RFQ_ID).productId(UPDATED_PRODUCT_ID).coverType(UPDATED_COVER_TYPE);
    ...
    void fullUpdateRFQProductsWithPatch() throws Exception {
        ...
        partialUpdatedRFQProducts.rfqId(UPDATED_RFQ_ID).productId(UPDATED_PRODUCT_ID).coverType(UPDATED_COVER_TYPE);
