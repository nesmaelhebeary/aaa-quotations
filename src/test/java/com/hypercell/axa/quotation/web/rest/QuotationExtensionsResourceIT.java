...
import com.hypercell.axa.quotation.domain.enumeration.EntensionPercentageType;
...
class QuotationExtensionsResourceIT {
    ...
    private static final EntensionPercentageType DEFAULT_ENTENSION_PERCENTAGE_TYPE = EntensionPercentageType.TotalSumInsured;
    private static final EntensionPercentageType UPDATED_ENTENSION_PERCENTAGE_TYPE = EntensionPercentageType.Section;
    ...
    public static QuotationExtensions createEntity(EntityManager em) {
        QuotationExtensions quotationExtensions = new QuotationExtensions()
            ...
            .entensionPercentageType(DEFAULT_ENTENSION_PERCENTAGE_TYPE)
    ...
    public static QuotationExtensions createUpdatedEntity(EntityManager em) {
        QuotationExtensions quotationExtensions = new QuotationExtensions()
            ...
            .entensionPercentageType(UPDATED_ENTENSION_PERCENTAGE_TYPE)
    ...
    void createQuotationExtensions() throws Exception {
        ...
        assertThat(testQuotationExtensions.getEntensionPercentageType()).isEqualTo(DEFAULT_ENTENSION_PERCENTAGE_TYPE);
    ...
    void getAllQuotationExtensions() throws Exception {
        ...
        restQuotationExtensionsMockMvc
            ...
            .andExpect(jsonPath("$.[*].entensionPercentageType").value(hasItem(DEFAULT_ENTENSION_PERCENTAGE_TYPE.toString())))
    ...
    void getQuotationExtensions() throws Exception {
        ...
        restQuotationExtensionsMockMvc
            ...
            .andExpect(jsonPath("$.entensionPercentageType").value(DEFAULT_ENTENSION_PERCENTAGE_TYPE.toString()))
    ...
    void putNewQuotationExtensions() throws Exception {
        ...
        assertThat(testQuotationExtensions.getEntensionPercentageType()).isEqualTo(UPDATED_ENTENSION_PERCENTAGE_TYPE);
